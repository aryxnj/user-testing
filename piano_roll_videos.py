...
MIDI_FILES = [
    ...
    'input-5.mid',
    'input-6.mid',
    'output-3-attention.mid',
    'output-3-basic.mid',
    'output-3-lookback.mid',
    'output-3-mono.mid',
    'output-4-attention.mid',
    'output-4-basic.mid',
    'output-4-lookback.mid',
    'output-4-mono.mid',
    'output-5-attention.mid',
    'output-5-basic.mid',
    'output-5-lookback.mid',
    'output-5-mono.mid',
    'output-6-attention.mid',
    'output-6-basic.mid',
    'output-6-lookback.mid',
    'output-6-mono.mid'
]
...
def process_midi_file(midi_file, output_dir):
    """
    Process a single MIDI file: convert to audio, generate frames, and create video.
    """
    input_path = os.path.join(CURRENT_DIR, midi_file)
    ...
    if not os.path.isfile(input_path):
        print(f"  Input MIDI file '{midi_file}' not found. Skipping.\n")
        return
...
def main():
    ...
    # Process each MIDI file in the list
    for midi_file in MIDI_FILES:
        try:
            process_midi_file(midi_file, OUTPUT_VIDEO_DIR)
